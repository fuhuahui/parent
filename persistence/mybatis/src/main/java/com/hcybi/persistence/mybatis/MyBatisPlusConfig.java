...
package com.hcybi.persistence.mybatis;
...
public class MyBatisPlusConfig {
    ...
    static final String MB_MAPPER_PACKAGE = "com.hcybi.**.mapper";
    static final String MB_MODEL_PACKAGE = "com.hcybi.**.entity";
    static final String MB_ENUMS_PACKAGE = "com.hcybi.**.entity.enums";
