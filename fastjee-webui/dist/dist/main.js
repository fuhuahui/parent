...
var commonRouterMap = exports.commonRouterMap = [{ path: '/login', name: 'login', meta: { title: '登陆系统 - Fastjee' }, component: function component() {
        return __webpack_require__.e/* import() */(6).then(__webpack_require__.bind(null, 264));
    } }, { path: '/locking', name: 'locking', meta: { title: '页面已锁定 - Fastjee' }, component: function component() {
        return __webpack_require__.e/* import() */(10).then(__webpack_require__.bind(null, 265));
    } }, { path: '/403', name: 'error-403', meta: { title: '403 - 权限不足' }, component: function component() {
        return __webpack_require__.e/* import() */(21).then(__webpack_require__.bind(null, 266));
    } }, { path: '/500', name: 'error-500', meta: { title: '403 - 内部错误' }, component: function component() {
        return __webpack_require__.e/* import() */(19).then(__webpack_require__.bind(null, 267));
    } }, { path: '/404', name: 'error-404', meta: { title: '404 - 页面不存在' }, component: function component() {
    ...
    data: function data() {
        ...
        return {
            ...
            updatePwdFormRules: {
                ...
                reNewPassword: [{ required: true, message: '重复密码不能为空', trigger: 'blur' }, { validator: validateReNewPassword, trigger: 'blur' }]
            }
        };
    },
            ...
            this.$refs.updatePwdForm.validate(function (valid) {
                if (valid) {
                    ...
                    _this3.$store.dispatch('UpdatePassword', _this3.updatePwdForm).then(function () {
                        ...
                        _this3.$Notice.success({ title: '操作成功,将在3秒后注销登录' });
                        setTimeout(function () {
...
var render = function render() {
  ...
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _c("div", { staticStyle: { display: "inline-block", padding: "0 6px" } }, [_c("Tooltip", { attrs: { content: "配色方案", placement: "right" } }, [_c("Dropdown", { attrs: { trigger: "click" }, on: { "on-click": _vm.setTheme } }, [_c("a", { attrs: { href: "javascript:void(0)" } }, [_c("Icon", {
...
var render = function render() {
  ...
  return _c("div", { staticClass: "main", class: { "main-hide-text": _vm.shrink } }, [_c("div", {
  ...
  }), _vm._v(" "), _c("lock-screen"), _vm._v(" "), _c("div", { staticClass: "lock-screen-btn-con" }, [_c("Tooltip", { attrs: { content: "下载源码", placement: "bottom" } }, [_c("a", {
    ...
    on: { click: _vm.logout }
  }, [_vm._v("注销登录")])], 1)])], 1)], 1)], 1)], 1)]), _vm._v(" "), _c("div", { staticClass: "tags-con" }, [_c("tags-page-opened", {
    ...
    attrs: { slot: "header" },
    slot: "header"
  }, [_c("Icon", { attrs: { type: "information-circled" } }), _vm._v(" "), _c("span", [_vm._v("修改密码")])], 1), _vm._v(" "), _c("Form", {
    ref: "updatePwdForm",
    attrs: {
  ...
  }, [_c("FormItem", { attrs: { prop: "oldPassword", label: "原始密码" } }, [_c("Input", {
    attrs: {
      type: "password",
      placeholder: "请输入原始密码",
      icon: "locked"
  ...
  })], 1), _vm._v(" "), _c("FormItem", { attrs: { prop: "newPassword", label: "新密码" } }, [_c("Input", {
    attrs: {
      type: "password",
      placeholder: "请输入新密码",
      icon: "locked"
  ...
  })], 1), _vm._v(" "), _c("FormItem", { attrs: { prop: "reNewPassword", label: "重复密码" } }, [_c("Input", {
    attrs: {
      type: "password",
      placeholder: "再次输入新密码",
      icon: "locked"
