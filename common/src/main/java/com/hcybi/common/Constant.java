...
public class Constant {
    ...
    public static class Service {
        public final static String FASTJEE_REGISTRATION = "hcybi-registration";
        public final static String FASTJEE_CONFIG = "hcybi-config";
        public final static String FASTJEE_GATEWAY = "hcybi-gateway";
        public final static String FASTJEE_AUTHORITY = "hcybi-authority";
        public final static String FASTJEE_USERCENTER = "hcybi-user";
    }
